...
class TbWidget extends CBehavior
{
    ...
    protected function getApi()
    {
        if (isset($this->_api)) {
            ...
            return $this->_api = Mod::app()->getComponent('bootstrap');
        }
    }
    ...
    protected function getClientScript()
    {
        if (isset($this->_clientScript)) {
            ...
            if (!Mod::app()->hasComponent('clientScript')) {
                return false;
            }
            return $this->_clientScript = Mod::app()->getComponent('clientScript');
        }
    }
}