...
class GoodsCat extends BaseModel
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('cat_id, parent_id, cat_path, is_leaf, type_id, cat_name, gallery_setting, disabled, p_order, goods_count, tabs, finder, addon, child_count, last_modify', 'safe', 'on'=>'search'),
		);
	}
