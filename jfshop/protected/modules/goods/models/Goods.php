...
class Goods extends BaseModel
{
	...
	public function rules()
	{
        ...
        return array(
            ...
            array('price, cost, mktprice, weight, unit , freez , price_jifen,freez', 'length', 'max'=>20),
            ...
            array('intro, goods_setting, spec_desc, params ,spec_info', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('goods_id, bn, name, type_id, cat_id, brand_id, store, price, cost, mktprice, weight, unit, goods_type, image_default_id, brief, intro, goods_setting, is_spec, spec_desc, params, marketable, p_order, create_time, update_time, disabled, paytype,price_jifen,freez,spec_info ', 'safe', 'on'=>'search'),
        );
	}
