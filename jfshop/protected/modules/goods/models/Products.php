...
class Products extends BaseModel
{
	...
	public function rules()
	{
        ...
        return array(
            ...
            array('goods_id, price, cost, mktprice, weight, unit ,price_jifen', 'length', 'max'=>20),
            ...
            array('product_id, goods_id, barcode, title, bn, price, cost, mktprice, name, weight, unit, store, price_jifen,store_place, freez, goods_type, spec_info, spec_desc, is_default, qrcode_image_id, uptime, last_modify, disabled, marketable', 'safe', 'on'=>'search'),
        );
	}
    ...
    public function typeProduct($goods_id,$params)
    {
        ...
        $sql = '';
//        $sql .= "UPDATE {{b2c_products}} SET disabled = 'true' WHERE goods_id = {$goods_id} AND spec_desc <> '';";
        $sql .= "UPDATE {{b2c_products}} SET {$updateSet} WHERE goods_id = {$goods_id} ;";
