                            ...
                            <tr>
                                <td class="shopping-cart-image">
                                    <a href="/product.html?id=<?php echo $v['product_id'];?>" target="_blank">
                                        <img src="<?php echo $this->_siteUrl.'/'.$v['image'];?>" alt="Berry Lace Dress">
                                    </a>
                                </td>
                                ...
                                <td class="shopping-cart-price">
                                    <strong>
                                    <?php if($v['paytype']==3){?>
                                    <span>积分：</span><?php echo $v['price_jifen']?>
                                    <?php }else{?>
                                ...
                                <td class="shopping-cart-total">
                                    <strong>
                                        <?php if($v['paytype']==3){?>
                                        <span>积分：</span><?php echo $v['price_jifen']*$v['quantity']?>
                                        <?php }else{?>
                                        <span>￥</span><?php echo $v['price']*$v['quantity']?>
                                        <?php } ?>
                                    </strong>
                                </td>
