                            ...
                            <table class="table table-striped table-bordered table-advance table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo Mod::app()->params['order_status'][$model['order_info']['status']];?></td>
                                    </tr>
                                    <tr>
                                        <td class="col-sm-3 text-align-right">付款状态：</td>
                                        <td><?php echo Mod::app()->params['pay_status'][$model['order_info']['pay_status']];?></td>
                                    </tr>
                                    <tr>
                                        <td class="col-sm-3 text-align-right">配送状态：</td>
                                        <td><?php echo Mod::app()->params['ship_status'][$model['order_info']['ship_status']];?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-advance table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo Mod::app()->params['payment_name'][$model['order_info']['payment']];?></td>
                                </tr>
                                <tr>
