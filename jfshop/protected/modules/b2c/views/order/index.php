<div class="container">
    <ul class="breadcrumb">
        ...
        <?php endif;?>
        <?php if ($model['pay_status'] != 'false'):?>
            <li class="active"><?php echo Mod::app()->params['pay_status'][$model['pay_status']];?>订单</li>
        <?php endif;?>
    </ul>
                    ...
                    <table class="table table-striped table-bordered table-advance table-hover">
                        ...
                        <?php foreach ($model['order_list'] as $v):?>
                            <tr>
                                ...
                                <td>
                                    <?php foreach ($v['product'] as $vv):?>
                                        <a href="/product.html?id=<?php echo $vv['product_id'];?>" target="_blank">
                                            <img style="width: 50px;height: 50px;" src="<?php echo $this->_siteUrl.'/'.$vv['image'];?>" alt="<?php echo $vv['name'];?>">
                                        </a>
                                    <?php endforeach;?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <?php echo Mod::app()->params['order_status'][$v['status']];?>
                                </td>
                                <td>
                                    <?php echo  Mod::app()->params['pay_status'][$v['pay_status']];?>
                                </td>
                                <td>
