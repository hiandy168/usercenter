                ...
                <div class="col-md-12 clearfix">
                                ...
                                <tr>
                                    <td class="shopping-image">
                                        <a href="/product.html?id=<?php echo $v['product_id'];?>" target="_blank">
                                            <img style="width: 100px;height: 100px;" src="<?php echo $this->_siteUrl.'/'.$v['image'];?>" alt="Berry Lace Dress">
                                        </a>
                                    </td>
                    ...
                    <div class="checkout-total-block">
                        <ul>
                            <li>
                                <em>商品总计</em>
                                <strong class="price"><span>￥</span><?php  echo $amount['amount_price'];?><span>积分</span><?php echo $amount['amount_price_jifen'];?></strong>
                            </li>
                            <li>
                                <em>物流费</em>
                            ...
                            <li class="shopping-total-price">
                                <em>总价</em>
                                <strong class="price"><span>￥</span><?php echo $amount['amount_price']+5.00;?><span>积分</span><?php echo $amount['amount_price_jifen']+5.00;?></strong>
                            </li>
                        </ul>
                    </div>
