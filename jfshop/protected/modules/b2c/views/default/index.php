        ...
        <div class="sidebar col-md-3 col-sm-4">
            <ul class="list-group margin-bottom-25 sidebar-menu">
                ...
                <li class="list-group-item clearfix <?php if ($v['child']):?>dropdown<?php endif;?>">
                    <a href="<?php echo $v['child']?'javascript:void(0);':$this->createAbsoluteUrl('/category.html?cid='.$v['cat_id']);?>" <?php if ($k==1):?>class="collapsed" <?php endif;?>>
                    ...
                    <ul class="dropdown-menu" <?php if ($k == 1):?>style="display: block;" <?php endif;?>>
                        ...
                        <li class="list-group-item">
                            <a href="<?php echo $this->createAbsoluteUrl('category',array('cid'=>$vv['cat_id']))?>">
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="<?php echo Mod::app()->theme->baseUrl; ?>/temp/index-sliders/slide1.jpg" class="img-responsive" alt="Berry Lace Dress">
                        </div>
                        <div class="item">
                            <img src="<?php echo Mod::app()->theme->baseUrl; ?>/temp/index-sliders/slide2.jpg" class="img-responsive" alt="Berry Lace Dress">
                        </div>
                        <div class="item">
                            <img src="<?php echo Mod::app()->theme->baseUrl; ?>/temp/index-sliders/slide3.jpg" class="img-responsive" alt="Berry Lace Dress">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <?php foreach (Layouts::brand() as $v):?>
                        <li>
                            <a href="product-list.html">
                                <img src="<?php echo $this->_siteUrl.'/'.$v['brand_logo'];?>" style="width: 153px;height: 92px;" alt="<?php echo $v['brand_name'];?>" title="<?php echo $v['brand_name'];?>">
                            </a>
                        </li>
                    <?php endforeach;?>
                </ul>
