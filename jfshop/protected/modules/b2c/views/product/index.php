<script>
var siteUrl = "<?php echo $this->_siteUrl; ?>/b2c";
</script>
<div class="container">
<ul class="breadcrumb">
    <li><a href="/">首页</a></li>
    <?php if ($model['parent_cat']):?>
    <li><a href="<?php echo $this->_siteUrl?>/category.html?cid=<?php echo $model['cat']['parent_id'];?>"><?php echo $model['parent_cat']['cat_name'];?></a></li>
    <?php endif;?>
    <li><a href="<?php echo $this->_siteUrl?>/category.html?cid=<?php echo $model['cat']['cat_id'];?>"><?php echo $model['cat']['cat_name'];?></a></li>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                ...
                <div class="product-main-image">
                    <img src="<?php echo $this->_siteUrl.'/'.$image['m_image'][0];?>"
                         alt="Cool green dress with red bell" class="img-responsive"
                         data-BigImgSrc="<?php echo $this->_siteUrl.'/'.$image['l_image'][0];?>"
                        >
                </div>
                <div class="product-other-images">
                    <?php if (isset($image['s_image'])):?>
                    <?php foreach ($image['s_image'] as $k=>$v):?>
                    <a href="#" class="album <?php if ($k == 0):?>active<?php endif;?>" b_img="<?php echo $this->_siteUrl.'/'.$image['l_image'][$k];?>"
                       m_img="<?php echo $this->_siteUrl.'/'.$image['m_image'][$k];?>">
                        <img alt="Berry Lace Dress" src="<?php echo $this->_siteUrl.'/' .$v;?>">
                    </a>
                    <?php endforeach;?>
                    <?php endif;?>
                </div>
