<div class="container">
    <ul class="breadcrumb">
        <li><a href="<?php echo $this->_siteUrl;?>">首页</a></li>
        <li><a href="<?php echo $this->_siteUrl;?>/account/index.html">会员中心</a></li>
                        ...
                        <form class="form-horizontal form-without-legend form-login" method="post">
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-offset-4 padding-left-0">
                                    <a href="<?php echo $this->_siteUrl;?>/account/register">免费注册</a>
