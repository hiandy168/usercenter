...
class UserController extends BaseController
{
    ...
    {
        $search['name'] = Tool::getValidParam('name');
        $conditionArr = array();
        $condition = '';
    ...
    {
        $user_id = Tool::getValidParam('user_id');
        $user_row = AdminUsers::model()->find("user_id = $user_id");
        if ($_POST) {
            $UserAttr = Tool::getValidParam('User');
        ...
        if (Tool::getValidParam('save')) $param['save'] = Tool::getValidParam('save');
        if (Tool::getValidParam('result')) $param['result'] = Tool::getValidParam('result');
