...
class Params {
    ...
    public static function Member($member_id)
    {
        ...
        //Mod::app()->cache->set($cache_name,$item);
    ...
    {
        $cache_name = 'dlytype';
        $dly_list = Mod::app()->cache->get($cache_name);
