...
//         die();
    ...
    public function actionIndex() {
        $this->type = Tool::getValidParam('a');
    ...
    public function actionDefault() {
        $this->width = Tool::getValidParam('width');
        $this->height = Tool::getValidParam('height');
    ...
    public function actionProduct()
    {
        ...
        $addtime='./images/'.$date;
        $path = $addtime.'/';
        file_put_contents('texttttwwwwww.txt', $path,FILE_APPEND);
        if (!file_exists($path)) mkdir($path,0777);
        ...
        //生成缩略图
        $this->imgthumb($addtime.'/'.$newf_name,$this->prep_filename($addtime.'/'.$newf_name,'_l'),640,480);
        $this->imgthumb($addtime.'/'.$newf_name,$this->prep_filename($addtime.'/'.$newf_name,'_m'),640,480);
        $this->imgthumb($addtime.'/'.$newf_name,$this->prep_filename($addtime.'/'.$newf_name,'_s'),640,480);
    ...
    {
        $src_img = str_replace('protected','',Mod::app()->basePath).$src_img;
        $dst_img = str_replace('protected','',Mod::app()->basePath).$dst_img;
