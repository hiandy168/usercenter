...
$('#file_upload').uploadify({
    ...
    checkExisting   : false,
    debug           : false,
    'swf'      : siteurl+'/themes/bootstrap/images/uploadify.swf',
    'uploader' : siteurl+'/admin.php?r=upload/product',
    'width':90,
    ...
    'onUploadSuccess' : function(file, data) {
        ...
        var html ='<li><a data-rel="colorbox" title="商品图片" href="'+data.file_name+'" class="cboxElement">' +
            ...
            '<button class="btn btn-minier btn-pink arrowed image_delete_opt" imgid="'+data.image_id+'">删除</button></div></li>';
 ...
 */
$(function(){
    $('.goods_delete').on(ace.click_event, function() {
            ...
            buttons:
            {
                "success" :
                {
                    ...
                    "callback": function() {
                        ...
                        location.href='?r=goods/default/delete&goods_id='+id;
                    }
                },
                "danger" :
                {
