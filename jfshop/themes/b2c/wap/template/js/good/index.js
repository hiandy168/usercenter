...
$(document).ready(function(e) {
	...
	(function(){
		...
		function numchange(){
			...
			$('.num select').on('change',numchange);
		};
		$('.num select').on('change',numchange);
...
//		$sizeSelects.bind('change',sizechange);
		...
		$('.addtocart:not(:disabled)').on('click',function(){
...
//                                var size_id = size_arr[1];
                                ...
                                $.post(
                                    siteUrl+'/b2c/wap/cart/insert',
                                    {'goods_id':goodInfo.goods_id,'quantity':num},
                                    function (result) {
                                        if (result.code == 200) {
