...
<div class="mgt4 bgfff">
    ...
    <div class=" pos-r bb  f-order-info4 f-cpdetail-div5">
        <i><?php echo$houseinfo['createtime']?> <?php if($houseinfo['updatetime']){?>转 <?php echo $houseinfo['updatetime'] ?><?php }?></i>
        <ul>
            <li><a href="tel:<?php echo$houseinfo['createtime'] ?>" class="bgfff fcf74 b1px boru5">打电话</a></li>
        </ul>
    </div>
        ...
        <div class="f-cpdetail-div6-tabcon">
            <div class="f-cpdetail-tab-cyjl">
                ...
                <?php if($count>3){ ?>
                    ...
                    <input  class="more fs28 fc444 boru5 cpdetail-loadmore-btn" value="点击加载更多" readonly/>
                <?php } ?>
            </div>
        </div>
