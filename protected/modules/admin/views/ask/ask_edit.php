...
<div class="form_list">
    <form name="formview" id="formview" action="<?php echo $this->createUrl('/admin/ask/'.$fun); ?>" method="post">
...
<!--                <td rowspan="3" class="thumb" width="200" >
	...
	<tr>
		...
		<td  colspan='5'>
                    <input  style="width:600px;" type="text" name="title" id="title" class="required"  class="txtarea"  value="<?php echo isset($view['title'])?$view['title']:'';?>">
		</td>
	</tr>
<!--	<tr>
	...
	<tr>
		<td class="t">问题</td>
		<td  colspan='5'><textarea style="width:600px;height:150px;" name="description" id="description" class="editor"><?php echo isset($view['description'])?htmlspecialchars($view['description']):'';?></textarea></textarea></td>
        </tr>
...
<!--	<tr>
        ...
        <tr>
		<td class="t">回答</td>
		<td  colspan='5'><textarea style="width:600px;height:150px;" name="content" id="content" class="editor"><?php echo isset($view['content'])?htmlspecialchars($view['content']):'';?></textarea></td></tr>
<!--	 <tr>
...
<!--	<tr>
	...
	<tr>
        ...
        <tr>
		<td class="t">排序</td>
		<td  colspan='5'><input type="text" name="listorder" id="order" value="<?php if(isset($view['order'])){echo $view['order'];}else{echo '99';} ?>" ></td>
        </tr>
<!--        <tr>
		<td class="t">类型</td>
		<td>
