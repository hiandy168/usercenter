...
<!--                </div>-->
                <div class="center_search">
                    <form name="search_frm" action="<?php echo $this->createUrl("member/index") ?>" id="SearchFrm" method="post">
                        <input type="text" name="phone"  placeholder="输入手机号"  value="<?php echo isset($phone) ? $phone : ""; ?>" />
                        <input type="submit" name="search" class="btn btn-success"  value="搜索" />
                    </form>
