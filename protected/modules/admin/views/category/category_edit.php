<div class='bgf clearfix'>
            ...
            <div class="center_top clearfix">
                <ul>
                    <li><a   class="btn btn-primary" href="<?php echo $this->createUrl('category/add') ?>">添加栏目</a></span>  
                    </li>
                </ul>
            ...
            <div class="form_list">
                <form name="formview" id="formview" action="<?php echo $this->createUrl('/admin/category/'.$fun); ?>" method="post">
                    <input type="hidden" name="id" value="<?php echo isset($view['id']) ? $view['id'] : ''; ?>">
                    <table cellSpacing=0 width="100%" class="content_view">
                        <tr>
                            <td class='t'><?php echo  Mod::t('admin','category_name') ?>:</td>
                        ...
                        <tr>
                              <td class='t'><?php echo  Mod::t('admin','parent') ?>:</td><td>
                                <select name="fid"  >
                                      <option value="0" <?php if (isset($view['fid']) && 0 == $view['fid']): ?>selected<?php endif; ?>>顶级分类</option>
                                       <?php if(isset($categoryarr) &&!empty($categoryarr)){foreach($categoryarr as $key=>$cat){?>
                          ...
                          <tr>
                             <td class='t'><?php echo  Mod::t('admin','category_model') ?>:</td>
                            <td>
