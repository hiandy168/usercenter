...
var admin_url ="<?php echo Mod::app()->baseUrl.'/admin' ;?>";
function login(){
       ...
       var verify   = document.getElementById("verify").value;
        $.ajax({
            type: "post",
            url: "<?php echo Mod::app()->createAbsoluteUrl('admin/login/ajax_login'); ?>",
            ...
            success: function(data){
               if(data.state === 1){
                   ...
                   location.href="<?php echo Mod::app()->createAbsoluteUrl('admin/main/index')?>"+'?'+ Math.random();
               }else{
                        $('#mess_box').html(data.mess);
               }
               reverify_image();
