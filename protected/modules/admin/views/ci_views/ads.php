...
<div class="center_top">
    <div class="control_nav"> 
        <ul>
            ...
            <li class="btn_left"><a href="javascript:;" onclick="del_bat('<?php echo admin_url("ads/del")?>')">删除</a></li>    
            <li class="btn_right"><a href="javascript:;" onclick="submitorder('<?php echo admin_url("ads/order")?>')">排序</a></li>   
            <li class="btn_b"><a href="<?php echo admin_url('ads/add')?>"><?php echo lang('add')?></a></li>   
        </ul>
    </div>
		...
		<tbody>	
                     <?php foreach($group as $k=>$item){ ?>
                        <tr id="list_<?php echo $item['id']?>">
                          ...
                          <td><a href="<?php echo admin_url("ads/edit/{$item['id']}")?>">编辑</a> <a onclick="del('<?php echo admin_url("ads/del")?>','<?php echo $item['id'] ?>')" href="javascript:;">删除</a></td>
                        </tr>	
                    <?php } ?>
		</tbody>
	</table>
