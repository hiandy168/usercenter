		...
		<tbody>	
                     <?php foreach($list as $k=>$item){?>
                        <tr id="list_<?php echo $item['id']?>">
                          ...
                          <td><a class="a_edit" href="<?php echo admin_url("fragment/edit/{$item['id']}")?>"><?php echo lang('edit')?></a> <a class="a_del" onclick="del('<?php echo admin_url("fragment/del")?>','<?php echo $item['id'] ?>')" href="javascript:;"><?php echo lang('del')?></a></td>
                        </tr>	
                    <?php } ?>
		</tbody>
	</table>
<div class="center_footer clearfix">
        <ul>
            ...
            <li class="btn_b"><a href="javascript:;" onclick="del_bat('<?php echo admin_url("fragment/del")?>')"><?php echo lang('del')?></a></li>    
            <li class="btn_b"><a href="<?php echo admin_url('fragment/add')?>"><?php echo lang('add')?></a></li>   
            <li class="btn_b" style='margin:0 0 0 5px;'><a href="javascript:;" onclick="submitorder('<?php echo admin_url("fragment/order")?>')"><?php echo lang('order')?></a></li>   
