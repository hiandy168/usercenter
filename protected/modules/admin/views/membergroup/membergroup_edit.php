...
<ul>
    ...
    <li><a  class="btn  btn-primary" href="<?php echo $this->createUrl('membergroup/add')?>">点击添加用户分组</a></span></li>
</ul>
                ...
                <div class="form_list">
                       <form name="formview" id="formview" action="<?php echo $this->createUrl('/admin/membergroup/'.$fun);?>" method="post">
