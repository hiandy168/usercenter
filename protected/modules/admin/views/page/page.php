...
<div class="center_top clearfix">
    <div class="center_search"> 
        <form name="search_frm" action="<?php echo $this->createUrl("page/lists")?>" id="SearchFrm" method="post"> 
		...
		<tbody>	
                     <?php if(!empty($list)){foreach($list as $k=>$item){?>
                        <tr id="list_<?php echo $item['id']?>">
                          ...
                          <td><a class="a_edit" href="<?php echo $this->createUrl("page/edit/",array('id'=>$item['id']))?>">编辑</a> <a class="a_del" onclick="del('<?php echo $this->createUrl("page/del")?>','<?php echo $item['id'] ?>')" href="javascript:;">删除</a></td>
                        </tr>	
                     <?php }}else{ ?>
...
<div class="center_footer clearfix">
        <ul>
            ...
            <li><a class="btn btn-primary" href="javascript:;" onclick="del_bat('<?php echo $this->createUrl("page/del")?>')">删除</a></li>    
            <li><a class="btn btn-primary" href="<?php echo $this->createUrl('page/add')?>">添加</a></li>   
            <li style='margin:0 0 0 5px;'><a class="btn btn-primary" href="javascript:;" onclick="submitorder('<?php echo $this->createUrl("page/order")?>')">排序</a></li>   
