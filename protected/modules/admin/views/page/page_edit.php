...
<!--        <tr>
		<td class="t">英文</td>
		<td  colspan='4'>   <input type="text" value="<?php echo isset($view['enname'])?$view['enname']:'';?>" id="enname" name="enname" size="20"></td>
        </tr>-->
        <tr>
		<td class="t">别名(访问连接显示的，如果不填连接地址为ID)</td>
		<td  colspan='4'>   <input type="text" value="<?php echo isset($view['alias'])?$view['alias']:'';?>" id="alias" name="alias" size="20"></td>
        </tr>
	...
	<tr>
	 ...
	 <tr>
		...
		<td><input type="text" name="tpl" id="tpl"   onfocus="if(this.value=='/page/detail'){ this.value='';}" onblur="if(this.value==''){ this.value='/page/detail';}" style="color:#999999" value="<?php echo (isset($view['tpl']) &&$view['tpl'])?$view['tpl']:'/page/detail';?>"></td>
            </tr>
	<tr>
