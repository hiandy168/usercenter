...
<div class="center_top clearfix">
    <div class="center_top clearfix">
        <ul>
            <li><a class="btn btn-primary" href="<?php echo $this->createUrl('add') ?>">新增幻灯片</a></li>
        </ul>
    </div>
</div>
        ...
        <form name="list_frm" id="ListFrm" action="" method="post">
            <table width="100%" cellspacing="0">
                ...
                <tr>
                    ...
                    <th style="width: 100px;text-align: center">幻灯片图片</th>
                ...
                if(!empty($housecity)){
                    foreach ($housecity as $k => $item) { ?>
                        <tr id="list_<?php echo $item['id'] ?>">
                            ...
                            <td style="text-align: center"><?php echo $item['sort']; ?></td>
                            ...
                            <td style="text-align: center"><img width="80px" height="80px" src="<?php echo JkCms::show_img($item['img_url']) ?>"
                                alt="活动图片"/></td>
                            <td style="text-align: center">
                                <a class='delete' href="<?php echo $this->createUrl('add',array('id'=>$item['id']));?>">编辑</a>
                                <a class='delete' data-del-id="<?php echo $item['id']?>" href="javascript:;" onclick="delImg(<?php echo $item['id']?>)" >删除</a>
                            </td>
                        </tr>
                    <?php }}?>
                </tbody>
