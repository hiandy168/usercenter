  ...
  <table width="100%" cellspacing="0">
                     ...
                     <?php foreach($group as $k=>$item){?>
                        <tr id="list_<?php echo $item->id?>"     >
                          ...
                          <td>
                              ...
                              <a href="<?php echo $this->createUrl("usergroup/permission/",array("id"=>$item->id));?>">权限设置</a>
                              <?php }?>
                          </td>
                          <td>
                            <a class='a_edit' href="<?php echo $this->createUrl("usergroup/edit/",array('id'=>$item->id))?>">编辑</a> 
                            <?php if($item->id!=1){?>
                            <a class='a_del' onclick="del('<?php echo $this->createUrl("usergroup/del")?>','<?php echo $item->id ?>')" href="javascript:;">删除</a>
                            <?php } ?>
                          </td>
                        </tr>	
                    <?php  } ?>
      ...
      <div class="center_footer clearfix">
        <ul>
            ...
            <li><a class="btn btn-primary" href="javascript:;" onclick="del_bat('<?php echo $this->createUrl("usergroup/del")?>')">删除</a></li>    
<!--            <li><a class="btn btn-primary" href="javascript:;" onclick="submitorder('<?php echo $this->createUrl("usergroup/order")?>')">排序</a></li>   -->
            <li><a class="btn btn-primary" href="<?php echo $this->createUrl('usergroup/add')?>">添加</a></li>   
        </ul>
    </div>
