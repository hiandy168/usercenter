...
<div class="center_top">
    <div class="control_nav"> 
        <ul>
            ...
            <li><a class="btn btn-primary" href="<?php echo $this->createUrl('offices/add')?>">添加</a></li>   
        </ul>
    </div>
...
<!--                <td style='height:38px;background:none;border-bottom:1px solid #e6e6e6'><?php echo $item['model']?></td>-->
                ...
                <td style='height:38px;background:none;border-bottom:1px solid #e6e6e6'>
                    <a class="a_btn a_edit" href="<?php echo $this->createUrl("offices/edit/",array('id'=>$item['id']))?>">编辑</a> 
                    <a class="a_btn a_del" onclick="del('<?php echo $this->createUrl("offices/del")?>','<?php echo $item['id'] ?>')" href="javascript:;">删除</a>
                </td>
            </tr>	
            <?php }}else{ ?>
       ...
       <div class="center_footer clearfix">
        <ul> 
            <li><a class="btn btn-primary" href="<?php echo $this->createUrl('offices/add')?>">添加</a></li>   
            <li style='margin:0 0 0 5px;'><a class="btn btn-primary" href="javascript:;" onclick="submitorder('<?php echo $this->createUrl("offices/order")?>')">排序</a></li>   
        </ul>
    </div>
