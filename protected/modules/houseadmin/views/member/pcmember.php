        ...
        <div class='bgf clearfix'>
            ...
            <div class="center_top clearfix">
                <ul>
                    <li><span class="btn btn-primary">PC端用户管理</span></li>
...
-->                 <li> <a class="btn btn-primary" href="<?php echo $this->createUrl('member/pclists/status/1') ?>">已审核</a></li>
                ...
                <div class="center_search">
                    <form name="search_frm" action="<?php echo $this->createUrl("member/pclists") ?>" id="SearchFrm" method="post">
                        <input type="text" name="phone"  placeholder="输入手机号码"  value="" />
                                ...
                                <tr id="list_<?php echo $item['id'] ?>">
                                    ...
                                    <td>
                                       <!-- $item->pstatus 为真 代表 是pc 端注册的用户-->
                                        ...
                                        <?php }else if(!$item->pstatus){?>
                                            <a  class='btn btn-primary' style="background: #ccc;color:red" href="javascript:;">手机用户</a>
                                            <?php }else{?>
