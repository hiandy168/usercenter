    ...
    <div class="form_list">
        <form name="formview" id="formview" action="<?php echo $this->createUrl('/houseadmin/hactivity/add'); ?>" method="post">
            ...
            <table cellSpacing=0 width="100%" class="content_view">
                ...
                <tr>
                    <td class='t'>预存金额:</td>
                    <td ><input data-val="requir" placeholder="预存金额必须大于50" <?php echo $houseinfo['poststatus']==1 ? 'disabled="disabled"' : ''; ?> data-title="预存金额"  name="figue" id="figue"  size="35"  type="text" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"  value="<?php echo  isset($houseinfo['figue']) ? $houseinfo['figue'] : ''; ?>"><span style="color: red">*</span></td>
