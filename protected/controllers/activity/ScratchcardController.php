    ...
    public function actionActivitylist(){
        ...
        switch ($config['tag']) {
            ...
            case "user":
                ...
                $table_user = "dym_activity_scratch_user";
                ...
                $data['join'] = Mod::app()->db->createCommand()->select('count(0)')->from($table_user)->where('scratch_id=' . $config['aid'] . '  and (time between '.strtotime($last).' and '.$now.')')->queryRow();
