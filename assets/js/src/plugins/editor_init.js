...
//define(function(require, exports, module){
    ...
    var base_html = '<div class="btn-toolbar" data-role="editor-toolbar" data-target="#editor"><div class="btn-group">' +
               ...
               '<div class="btn-group">' +
               '<a class="btn pictureBtn" title="插入图片"><i class="icon-picture"></i></a></div>' +
               '<div class="btn-group" data-fullscreen="hide">' +
    ...
    var editor_insert = function(options){
        $('#' + options.id).hide();
        var new_html = base_html + '<div class="editor" style="position: relative;max-width: ' + options.width + '; height: ' + options.height + '; max-height: ' + options.height + '" id="edit_area_' + options.id + '"></div>';
