...
.showMsg{border: 1px solid #1e64c8; zoom:1; width:450px; height:172px;margin:50px auto}
...
<div class="showMsg" style="text-align:center">
	<h5>提示信息</h5>
    <div class="content guery" style="display:inline-block;display:-moz-inline-stack;zoom:1;*display:inline;max-width:330px;color:#000">
    <?php echo $content;?>
    </div>
    <div class="bottom">
         <p> 
