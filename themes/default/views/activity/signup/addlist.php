...
<body>
    <div style="margin: 10px;">
        <a class="btn btn-success" href="<?php echo $this->createUrl('/activity/signup/ExportCsv',array('fid'=>$id,'title'=>$title))?>" role="button">导出列表</a>
    </div>
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td><?php echo $val['utel']?></td>
            <td><?php echo $val['ucount'] ? $val['code'] :""?></td>
