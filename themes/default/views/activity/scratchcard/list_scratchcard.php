...
<div class="new_wrap">
    <div class="other_333 clearfix">
        <div class="right_222">
            <div class="i_222">组件 <span class="add-activity"><a href="<?php echo $this->createUrl('/activity/scratchcard/add',array('pid'=>$config['pid']))?>">+ 新增活动</a><span></div>
                ...
                <table class="table_222">
                    ...
                    <tr>    
                        ...
                        <td>                           
                            ...
                            <a class="icon_3" href="<?php echo $this->createUrl('/activity/scratchcard/add',array('fid'=>$val->id,'pid'=>$config['pid']))?>"></a>
                            <a class="icon_4" href="javascript:void(0);" onclick="delActivity(<?php echo $val->id?>)"></a>
                            <a href="<?php echo $this->createUrl('/activity/scratchcard/view',array('id'=>$val->id))?>" target="_blank">预览</a>
                    ...
                    <tr>
                      <td colspan="6" >
                        ...
                        <textarea style="width: 74%;line-height: 26px;border: 1px solid #E6E6E6;background: #FFFFFF;"><?php echo $view['wechat_url'].urlencode($this->_siteUrl.$this->createUrl('/activity/scratchcard/view',array('id'=>$val->id)))?></textarea>
    ...
    function getStatus(state,fid){
        if(state=='未开始'){
            layer.confirm('活动还未开始？活动的开始时间将被置为当前时间！', {
              ...
              var url = "<?php echo $this->createUrl('/activity/scratchcard/ActivityPause')?>";
