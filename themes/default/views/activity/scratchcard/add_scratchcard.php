...
<div style="">
            ...
            <div class="content" style="margin-top:20px;">
                ...
                ?>
                    ...
                    <div class="input">
                    <input type="text" value="<?php echo $val['title']?>" placeholder="" class="input_text" name="p_title[]" />
                    <div class="del"></div>
                    </div>
    ...
    <?php if($activity_info['id']){ ?>
        ...
        <div style="float: right; width: 305px;text-align: center; margin-top: 20px;">
            <a style="display: inline-block; padding: 10px 20px; border-radius: 3px; border: 1px solid #00AFD8;" target="view_window"  href="<?php echo $this->createUrl('/activity/scratchcard/view',array('id'=>$activity_info['id']))?>">请点击->>>活动链接</a>
        </div>
    <?php }else{?>
        <div class="right" style="float:right;margin:0">
...
$("#continue_ad_20160422").on('click', function () {
    var temp_html = '<div class="t_title">自定义名称</div>'+
        '<div class="input">'+
        '<input type="text" value="" placeholder="" class="input_text" name="p_title[]" />'+
        '<div class="del"></div>'+
        '</div>'+
        '<div class="t_title">奖品名称</div>'+
        '<div class="input">'+
...
var url          = "<?php echo $this->createUrl('/activity/scratchcard/add'); ?>";
