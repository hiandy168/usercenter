...
<div class="new_wrap">
    <div class="other_333 clearfix">
        <div class="right_222">
            <div class="i_222">组件 <span class="add-activity"><a href="<?php echo $this->createUrl('/activity/vote/add',array('pid'=>$config['pid']))?>">+ 新增活动</a><span></div>
            <div class="content_222">
                <table class="table_222">
                    ...
                    <tr>    
                        ...
                        <td><?php $result = Activity_vote::activityStatus($val->start_time,$val->end_time);echo $result['message']?></td>    
                        <td>                           
                            ...
                            <a class="icon_3" href="<?php echo $this->createUrl('/activity/vote/add',array('fid'=>$val->id,'pid'=>$config['pid']))?>"></a>
                            <a class="icon_4" href="javascript:void(0);" onclick="delActivity(<?php echo $val->id?>)"></a>
                            <a href="<?php echo $this->createUrl('/activity/vote/admin',array('vid'=>$val->id,'pid'=>$config['pid']))?>" target="_blank">管理</a>
                            <a href="<?php echo $this->createUrl('/activity/vote/view',array('id'=>$val->id,'pid'=>$config['pid']))?>" target="_blank">预览</a>
                        </td>
                    </tr>
                    ...
                    <tr>
                      <td colspan="6" >
                       ...
                       <div style="padding: 20px 10px;border-top: 1px solid #E6E6E6;border-bottom: 1px solid #E6E6E6;">
                        ...
                        <textarea style="width: 74%;line-height: 26px;border: 1px solid #E6E6E6;background: #FFFFFF;"><?php echo $view['wechat_url'].urlencode($this->_siteUrl.$this->createUrl('/activity/vote/view',array('id'=>$val->id)))?></textarea>
