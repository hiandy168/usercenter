...
//	}
	...
	$.ajax({
		...
		data:{token:token,mid:mid,pid:pid,account:account,password:password,verify:verify,rember:rember,return_url:return_url},
		dataType:'json',
		type:'post',
...
function regone(){
    ...
    $.ajax({
        ...
        data : {token:token,mid:mid,pid:pid,account:account,password:password,repassword:repassword,verify:verify,agree:agree},
        dataType : 'json',
        type : 'post',
        success : function(data){
            if(data.state==1){
