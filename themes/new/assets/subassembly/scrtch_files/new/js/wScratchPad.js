...
(function($)
{
	...
	$.fn.wScratchPad.defaultSettings =
	{
		...
		height		: 55,						// set height - best to match image height
	...
	ScratchPad.prototype = 
	{
		...
		setBgImage: function()
		{
			if(this.settings.image)
			{
				this.sp.css({'background-image': 'url('+this.settings.image+')','background-size':'100% 100%'});
			}
		},
