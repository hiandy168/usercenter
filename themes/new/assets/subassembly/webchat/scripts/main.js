$(function(){
  ...
  $.getJSON("/themes/new/assets/subassembly/webchat/mock/data.json",function(response){

    var allfeeds = response.data
    $.getJSON("/themes/new/assets/subassembly/webchat/mock/user-info.json",function (response) {
