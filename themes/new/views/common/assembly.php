                ...
                if (count($res) > 0) {
                    foreach ($res as $vals) {
                        ...
                        if ($res_check['activity_name'] == '刮刮乐') {
                            ...
                            $active_arr[] = 10;
                        } else if ($res_check['activity_name'] == '集卡') {
                            $active_arr[] = 11;
                        }
                        $temp[] = $res_check;
                    }
...
//                }
                ...
                ?>
                <li <?php if (in_array($active, $active_arr)) {
                    echo 'class="selected"';
                } ?>><b><?php echo $val['class_name']; ?></b></li>
            <?php } ?>
...
//            }
            ...
            <div class="ad-act-con-d" <?php if (in_array($active, $active_arr)) {
                echo 'style="display: block;"';
            } ?>>

                <div class="ad-act-con-d1">

                    <a class="lbtn" onclick="prevBtn(this)"><img
                            src="<?php echo $this->_theme_url; ?>assets/images/ad-act-lefticon.png"/></a>

                    <a class="rbtn" onclick="nextBtn(this)"><img
                            src="<?php echo $this->_theme_url; ?>assets/images/ad-act-righticon.png"/></a>

                    <div class="ad-act-con-d2 clearfix">
                        <ul>
                            <?php if ($temp) {
                                foreach ($temp as $val) { ?>
                                    <li <?php if ($active == $val['active']) {
                                        echo 'class="selected"';
                                    } ?> >
                                                                                    ...
                                                                                    <a href="<?php echo $this->createUrl('/activity/wenda/list', array('pid' => $pid, 'active' => 10)); ?>">
                                                                                        ...
                                                                                        <a href="#">
                                                                                            ...
                                                                                            <?php if ($val['activity_name'] == '众筹' || $val['activity_name'] == '零元购') { ?>
                                                                                                <img
                                                                                                    src="<?php echo $this->_theme_url . $val['activity_nouse_img']; ?>">
                                                                                            <?php } else { ?>
                                                                                                <img
