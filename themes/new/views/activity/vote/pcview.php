...
<body style="background: url(<?php echo $this->_theme_url; ?>assets/images/ad-views-main-bg2.png) center; background-size: cover;">
    ...
    <div class="ad-view-main">
        ...
        <iframe  src="<?php echo $this->createUrl('/activity/vote/view',array('id'=>$id))?>"></iframe>
        </div>
        </div>
    	...
    	<div class="ad-right-views">
    		...
    		<textarea id="fe_text" readonly="readonly"><?php echo $this->createAbsoluteUrl('/activity/vote/view',array('id'=>$id))?></textarea>
