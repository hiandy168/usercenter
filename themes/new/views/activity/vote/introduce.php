...
<div class="div-main">
    <div class="vote-main">
        <div class="pos-r">
            <img src="<?php echo JkCms::show_img($img); ?>" width="100%" />
            <!-- <div class="pos-a linear-bg"></div> -->
        </div>



        <div class="vote-hd-note1 bsd1">
            <h3 class="pos-r bb t1">活动说明</h3>
				<span>
					<?php echo $desc?>
				</span>
        </div>
    ...
    <?php /*echo $this->renderpartial('/common/footer_app',array('active'=>2,'id'=>$id,'pid'=>$pid,'param'=>$param)); */?>
