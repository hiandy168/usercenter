...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $this->_theme_url; ?>assets/subassembly/pccheckin/css/style.css"/>
    <script src="<?php echo $this->_theme_url; ?>assets/subassembly/pccheckin/js/layout.js" type="text/javascript" charset="utf-8"></script>
    <script src="<?php echo $this->_theme_url; ?>assets/subassembly/pccheckin/js/jquery-1.12.0.min.js" type="text/javascript" charset="utf-8"></script>
...
<div class="signin-pop">
    <div class="signin-popinfo">
        ...
        <img class="t-bg" src="<?php echo $this->_theme_url; ?>assets/subassembly/pccheckin/images/signin-img2.png" width="100%" />
        ...
        <img class="b-bg" src="<?php echo $this->_theme_url; ?>assets/subassembly/pccheckin/images/signin-img4.png" width="100%" />
    </div>
     <?php if($explorer==1){ ?>
       <div class="pcclose">
...
<div class="div-main" style="    background: url(<?php echo $this->_theme_url; ?>assets/subassembly/pccheckin/images/signin-bg.jpg) #fff no-repeat fixed top center;background-size: cover; overflow: hidden;">

    <input type="hidden" name="openid" id="openid" value="<?php echo $openid;?>" />
    <div class="signin-div1">
        <img class="bg" src="<?php echo $this->_theme_url; ?>assets/subassembly/pccheckin/images/signin-img1.png" width="100%"/>
