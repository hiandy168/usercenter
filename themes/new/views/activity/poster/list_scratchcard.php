...
<div class="ad-act-list w1000 bxbg mgt30 clearfix">
    ...
    <div class="ad-app-list-tit clearfix">
        ...
        <div class="fr tr">
            <a href="<?php echo $this->createUrl('/activity/poster/add',array('pid'=>$config['pid']))?>">
    ...
    <div class="ad-nodata w1000 mgb30 mgt30">
        ...
        <p>噢噢，还没有记录！！！</p>
        <a href="<?php echo $this->createUrl('/activity/poster/add',array('pid'=>$config['pid']))?>" class="linear adbtn">创建活动</a>
    </div>
    <?php  }else {
    ?>
            ...
            <ul>
                <?php if($asList):foreach($asList as $val): ?>
                    <li class="li">
                        <div class="ad-act-list-table-con1 clearfix">
                            <ul>
                                ...
                                <li class="lw3"><?php echo date('Y-m-d H:i:s',$val->starttime);?></li>
                                <li class="lw3"><?php echo date('Y-m-d H:i:s',$val->endtime);?></li>
                                <li class="lw2"><?php $result = Activity_poster::activityStatus($val->starttime,$val->endtime);echo $result['message']?></li>
                            </ul>
                        </div>
                    ...
                    <div class="ad-act-list-wlink">
                      <h4>活动链接</h4>
                      <span><textarea name="" rows="" cols=""><?php echo "http://".$_SERVER['HTTP_HOST'].$this->createUrl('/activity/poster/view',array('id'=>$val->id))?></textarea></span>
                      <em onclick="Copy(this)">点击复制</em>
                    </div>
                    </li>
                                <li class="l5"><a href="<?php echo $this->createUrl('/activity/poster/add',array('fid'=>$val->id,'pid'=>$config['pid']))?>"><i></i>编辑</a></li>
                                <li class="l1"><a href="<?php echo $this->createUrl('/activity/poster/view',array('id'=>$val->id))?>" target="_blank"><i></i>预览</a></li>
    ...
    function getStatus(state,fid){
        if(state=='未开始'){
            layer.confirm('活动还未开始？活动的开始时间将被置为当前时间！', {
              ...
              var url = "<?php echo $this->createUrl('/activity/poster/activitystatus')?>";
