...
<body>
<form action="<?php echo $this->createUrl('/activity/poster/WinList/fid/'.$id)?>" method="post">
    <div style="margin: 10px;">
        <input type="text" value="<?php echo $content ?>" name='content' placeholder="请输入海报名称" class="btn" style="margin-right: 10px; border: 1px solid #ccc" />
