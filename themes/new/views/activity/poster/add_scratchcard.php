                    ...
                    <div class="ad-edit-app-1form">
                        ...
                        <div class="ad-act-formmain">
                            ...
                            <div class="form-content">
                                ...
                                <div class="form-inp">
                                      <span>
                                        <input type="text" value="<?php echo isset($activity_info['starttime']) ? date('Y-m-d H:i:s', $activity_info['starttime']) : ''; ?>" placeholder="请填写活动开始时间" class="form-control" name="start_time" id="start" /></span>

                                </div>
                                <div class="t_title">活动结束时间<span>请填写活动结束时间</span></div>
                                <div class="form-inp">
                                      <span>
                                        <input type="text" value="<?php echo isset($activity_info['endtime']) ? date('Y-m-d H:i:s', $activity_info['endtime']) : ''; ?>" placeholder="请填写活动结束时间" class="form-control" name="end_time" id="end" /></span>

                                </div>
                                <!-- 上传图片1 start -->
                                <div class="t_title"><i style="color: red">*</i>海报背景图片(图片大小：640*280)</div>
                                <div class="form-inp">
                                    <form id="img_scratchcard" method="POST" enctype="multipart/form-data" >
                                        ...
                                        <input class="fileinput" style="display: none" type="file" onchange="uploadImg(this,'img','imgPreview_vote','img_scratchcard')"  name="imgFile" id="upimg1" value="" />
                                    </form>
...
<!--
                <div class="ad-view-app-1 ad-edit-app-condiv clearfix" >
                    ...
                    <div class="ad-view-app-code">
                        ...
                        <img src="http://qr.topscan.com/api.php?text=<?php /*echo $this->_siteUrl.'/activity/poster/view/id/'.$activity_info['id']*/?>" width="150" height="150"/>
                        <?php /*}else{*/?>
...
$redirect   =   'http://m.dachuw.net/activity/poster/view/id/<?php echo $_GET['fid'] ?>';
//获取自动登录URL
...
$('.save_button').click(function(){
    ...
    if(!title||!start_time||!end_time||!share_img||!img){
        layer.msg("所有参数为必填");
        return false;
    }
    if(!tag){
