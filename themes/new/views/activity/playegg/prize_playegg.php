                ...
                <div class="ad-edit-app-1 ad-edit-app-condiv  clearfix" style="display: block;">
                    ...
                    <div class="form-content  dail-formdiv1">
                        ...
                        <div class="tips" style="margin-bottom: 0;">
                            <em>*Tips：</em>
                            <p>本模块为砸金蛋活动基本信息，为了保证活动顺利创建，除活动规则和领奖方式选填外其余的为必填。</p>
    ...
    <script type="text/javascript">
      ...
      $("html").on("click",".delbtn",function(){
        ...
        $("#continue_ad_20160422").on('click', function () {
            ...
            //     tit = '五等奖';
            // } 
            var temp_html = '<div class="s_num"><div class="t_title">自定义名称 <span class="adbtn linear delbtn">删除该项</span></div>' +
                '<div class="form-inp">' +
        ...
        var url = "<?php echo $this->createUrl('/activity/playegg/prize'); ?>";
