    ...
    <div class="ad-edit-app">
        <div class="ad-edit-app-navsd ">
             <ul>
                    ...
                    <li>
                        <?php if($activity_info['id']){ ?>
                        <a href="<?php echo $this->createUrl('/activity/playegg/prize',array('id'=>$activity_info['id']))?>">奖品/概率</a>
                        <?php }else{ ?>
                    ...
                    <li class="">
                         <?php if($activity_info['id']){ ?>
                        <a href="<?php echo $this->createUrl('/activity/playegg/example',array('id'=>$activity_info['id']))?>">开发者示例</a>
                        <?php }else{ ?>
                    ...
                    <div class="ad-act-formmain">
                        ...
                        <div class="form-content">
                          ...
                          <!--  <div class="t_title">次数结束提示</div>
                            ...
                            <!-- 上传图片1 start -->
                            <div class="t_title"><i style="color: red">*</i>砸金蛋banner图片(图片大小：640*280)</div>
                            <div class="form-inp">
                                <form id="img_scratch" method="POST" enctype="multipart/form-data" >
                                    <img id="imgPreview_vote" width="120px" height="100px"  onclick="upload('upimg1')" src="<?php if($activity_info['banner_img']) {echo JkCms::show_img($activity_info['banner_img']); }else{ echo $this->_theme_url."assets/subassembly/playegg/images/deggs-img1.jpg";} ?> "/>
                            ...
                            <!--
                            <div class="t_title"><i style="color: red">*</i>砸金蛋背景图片(最佳尺寸：750*740)</div>
                            <div class="form-inp">
                                <form id="from_bg_img" method="POST" enctype="multipart/form-data" >
                                    <img id="img_bg_img" width="120px" height="100px" onclick="upload('up_bg_img')" src="<?php /*if($activity_info['bg_img']) {echo JkCms::show_img($activity_info['bg_img']); }else{ echo $this->_theme_url."assets/subassembly/playegg/images/deggs-img2.jpg";} */?> "/>
                            ...
                            <div class="form-inp">
                                <form id="from_myprize_img" method="POST" enctype="multipart/form-data" >
                                    <img id="img_myprize_img" width="120px" height="100px" onclick="upload('up_myprize_img')" src="<?php /*if($activity_info['myprize_img']) {echo JkCms::show_img($activity_info['myprize_img']); }else{ echo $this->_theme_url."assets/subassembly/playegg/images/deggs-img5.png";} */?> "/>
                            ...
                            <div class="t_title"><i style="color: red">*</i>完整金蛋图片(最佳尺寸：160*220)</div>
                            <div class="form-inp">
                                <form id="from_eggok_img" method="POST" enctype="multipart/form-data" >
                                    <img id="img_eggok_img" width="120px" height="100px" onclick="upload('up_eggok_img')" src="<?php /*if($activity_info['eggok_img']) {echo JkCms::show_img($activity_info['eggok_img']); }else{ echo $this->_theme_url."assets/subassembly/playegg/images/deggs-img4.png";} */?> "/>
                                    <input class="fileinput" style="display: none" type="file" onchange="uploadImg(this,'eggok_img','img_eggok_img','from_eggok_img')"  name="imgFile" id="up_eggok_img" value="" />
                                </form>
                                <input type="hidden" name="eggok_img" id="eggok_img" value="<?php /*echo $activity_info['eggok_img']*/?>">
                            </div>


                            <div class="t_title"><i style="color: red">*</i>锤子图片(最佳尺寸：235*142)</div>
                            <div class="form-inp">
                                <form id="from_hammer_img" method="POST" enctype="multipart/form-data" >
                                    <img id="img_hammer_img" width="120px" height="100px" onclick="upload('up_hammer_img')" src="<?php /*if($activity_info['hammer_img']) {echo JkCms::show_img($activity_info['hammer_img']); }else{ echo $this->_theme_url."assets/subassembly/playegg/images/deggs-img5.png";} */?> "/>
                                    <input class="fileinput" style="display: none" type="file" onchange="uploadImg(this,'hammer_img','img_hammer_img','from_hammer_img')"  name="imgFile" id="up_hammer_img" value="" />
                                </form>
                                <input type="hidden" name="hammer_img" id="hammer_img" value="<?php /*echo $activity_info['hammer_img']*/?>">
                            </div>


                            <div class="t_title"><i style="color: red">*</i>破碎金蛋图片(最佳尺寸：198*187)</div>
                            <div class="form-inp">
                                <form id="from_eggno_img" method="POST" enctype="multipart/form-data" >
                                    <img id="img_eggno_img" width="120px" height="100px" onclick="upload('up_eggno_img')" src="<?php /*if($activity_info['eggno_img']) {echo JkCms::show_img($activity_info['eggno_img']); }else{ echo $this->_theme_url."assets/subassembly/playegg/images/deggs-img3.png";} */?> "/>
                                    <input class="fileinput" style="display: none" type="file" onchange="uploadImg(this,'eggno_img','img_eggno_img','from_eggno_img')"  name="imgFile" id="up_eggno_img" value="" />
                                </form>
                                <input type="hidden" name="eggno_img" id="eggno_img" value="<?php /*echo $activity_info['eggno_img']*/?>">
                            </div>-->
...
<script type="text/javascript">
            ...
            layer.confirm('确定暂停活动么？', {
              btn: ['确定','取消'] //按钮
                        ...
                        if(id){
                            $.ajax({
                            type: "POST",
                            url: "<?php echo $this->createUrl('/activity/playegg/activitystatus'); ?>",
                            data:{ "id": id,'type':2},
                            dataType:'json',
    ...
    $('.save_button').click(function(){
        ...
        if(id){
            $.ajax({
                type: "POST",
                url: "<?php echo $this->createUrl('/activity/playegg/is_status'); ?>",
                data:{
                    "id": id,
                },
        ...
        if(!title|| !start_time|| !end_time|| !win_num|| !day_count|| !rule|| !jishu  || !obj_p_title){
            layer.msg("所有参数为必填");
            return false;
        }
            ...
            if(res.state==1){
                layer.msg(res.msg,{time:2000},function(){
                        ...
                        if(res.aid &&  res.aid!='undefined'){
                            window.location.href = "<?php echo $this->createUrl('/activity/playegg/prize')?>"+'?id='+res.aid;
                        }else{
                           window.location.href = "<?php echo $this->createUrl('/activity/playegg/list') . '/pid/' . $config['pid'] . '/active/1'; ?>";
                        }
                })
