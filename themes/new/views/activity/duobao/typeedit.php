<?php echo $this->renderpartial('/common/header_new',$config); ?>
                ...
                <div class="ad-edit-app-1 ad-edit-app-condiv  clearfix" style="display: block">
                    <div class="ad-edit-app-1formbg fl">
                        <form id="img_form" method="POST" enctype="multipart/form-data" >
                            <img id="imgPreview" src="<?php if($edit['thumb']) {echo JkCms::show_img($edit['thumb']); }else{ echo $this->_theme_url."assets/images/1556c138f70cd73.png";} ?> "/>
                            <i>上传图像
                                <input class="fileinput" type="file" onchange="uploadImg(this)"  name="imgFile" id="upimg" value="<?php echo $activity_info['thumb']?>" /></i>
                            <input type="hidden" name="share_img" id="share_img" value="<?php echo $edit['thumb']?>">
                    ...
                    <div class="ad-edit-app-1form">
                        ...
                        <div class="ad-act-formmain">
                            ...
                            <div class="form-content">
                                ...
                                <div class="form-inp">
                                      <span>
                                        <input type="text" value="<?php echo isset($edit['name']) ? $edit['name'] : ''; ?>" placeholder="请填写分类名称" class="form-control " name="title" /></span>
                                </div>
                                ...
                                <div class="form-inp">
                                      <span>
                                        <input type="text" value="<?php echo isset($edit['description']) ? $edit['description'] : ''; ?>" placeholder="请填写分类名称" class="form-control " name="description" /></span>
                                </div>
                                <!-- 上传图片 end -->
    ...
    <script type="text/javascript">
        var url          = "<?php echo $this->createUrl('/activity/duobao/typeEdit'); ?>";
