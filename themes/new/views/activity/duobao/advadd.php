        ...
        <div class="ad-app-list w1000 clearfix bxbg mgt30">
            ...
            <div class="ad-data-map">
                ...
                <div class="form-content" style="margin-top:20px;">
                    ...
                    <div class="input">
                        <input type="text" value="<?php echo isset($activity_info['adv_name']) ? $activity_info['adv_name'] : ''; ?>"
                    ...
                    <div class="input">
                        <input type="text" value="<?php echo isset($activity_info['displayorder']) ? $activity_info['displayorder'] : ''; ?>"
                    ...
                    <div class="form-content" style="margin-top:20px;">
                        ...
                        <div class="form-content" style="margin-top:20px;">
                            ...
                            <div class="">
                                <img onclick="upload_pic('img_thumb1','icon1')" src="<?php echo JkCms::show_img($activity_info['thumb']) ?>" id="img_thumb1" width="30%"/>
                                <input type="hidden" name="share_img" id="icon1" value="<?php echo $activity_info['thumb']?>">
                            </div>
                        </div>
            ...
            <script type="text/javascript">
                ...
                var url          = "<?php echo $this->createUrl('/activity/duobao/advAdd'); ?>";
