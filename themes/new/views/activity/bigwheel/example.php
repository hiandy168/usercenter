              ...
              <!--   <div class="ad-view-app-1 ad-edit-app-condiv clearfix">
                    ...
                    <div class="ad-view-app-code">
                        <?php if ($activity_info['id']) { ?>
                            <img
                                src="http://qr.topscan.com/api.php?text=<?php echo $this->_siteUrl . '/activity/bigwheel/view/id/' . $activity_info['id'] ?>"
                    ...
                    <div class="ad-view-app-main">
                        ...
                        <div class="ad-view-app-maindiv">
                            <?php if ($activity_info['id']) { ?>
                                <iframe
                                    src="<?php echo $this->createUrl('/activity/bigwheel/view', array('id' => $activity_info['id'])) ?>"
...
$redirect   =   'http://m.dachuw.net/activity/bigwheelcard/view/id/<?php echo $_GET['fid'] ?>';
//获取自动登录URL
