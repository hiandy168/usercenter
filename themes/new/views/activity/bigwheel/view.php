...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo $this->_theme_url; ?>assets/subassembly/bigwheel/newassets/css/style.css?v201568asdas61269"/>
    </head>
    <body>
    ...
    <div class="mask"></div>
        ...
        <div class="dial-pop">
          ...
          <div class="popbg">
            <img src="<?php echo $this->_theme_url; ?>assets/subassembly/bigwheel/newassets/images/dial-img3.png" width="100%" />
          </div>
          <div style="display: none" class="dial-poptuletxt"><p style="max-height: 14rem;overflow: scroll;"><?php echo $info['rule'] ?></p></div>
            <div class="poptxt">
         ...
         <div class="confirmbtn">
            <img src="<?php echo $this->_theme_url; ?>assets/subassembly/bigwheel/newassets/images/dial-confirmbtn.png" width="100%" />
         </div>
              </div>
        ...
        <div class="div-main">
            <div class="">
               ...
               <?php }else{?>
                <img src="<?php echo $this->_theme_url; ?>assets/subassembly/bigwheel/newassets/images/dial-bg1.jpg" width="100%"/>
                <?php }?>
                <!-- end banner-->
            </div>
            <div class="pos-r dial-div1">
                ...
                <?php }else{?>
                <img src="<?php echo $this->_theme_url; ?>assets/subassembly/bigwheel/newassets/images/dial-bg2.jpg" width="100%"/>
                <?php }?>
                <!--转盘背景图片-->
                <div class="dial-zp">
                    <!--转盘图片-->
                    ...
                    <?php }else{?>
                         ...
                         <img class="dial-zp1" id="lotteryBg" src="<?php echo $this->_theme_url; ?>assets/subassembly/bigwheel/newassets/images/dial-img1_<?php echo $countprize?>.png"/>
                    <?php }?>
                    <!--end 转盘图片-->
                    <!--指针图片-->
                    ...
                    <?php }else{?>
                    <img class="dial-zp2" id="lotteryBtn" src="<?php echo $this->_theme_url; ?>assets/subassembly/bigwheel/newassets/images/dial-img2.png"/>
                    <?php }?>
                    <!-- end 指针图片-->
                 </div>
            </div>
            <div class="pos-r dial-div2">
                ...
                <?php }else{?>
                <img src="<?php echo $this->_theme_url; ?>assets/subassembly/bigwheel/newassets/images/dial-bg3.jpg" width="100%"/>
                <?php }?>
                <!--end 底部背景图片-->
                <!--中奖纪录按钮-->
                ...
                <?php }else{?>
                     <img class="dial-logbtn" src="<?php echo $this->_theme_url; ?>assets/subassembly/bigwheel/newassets/images/dial-logbtn.png"/>
                <?php }?>
                <!--end 中奖纪录按钮-->
                ...
                <div class="dial-zjlist">
                    <ul>
                        <?php foreach ($prize as $k=>$v):?>
                            <li><?php echo $v['title']?>:<?php echo $v['name']?><?php if($info['prize_number']==1){ echo "：".$v['count']."名";}?></li>
                        <?php endforeach;?>
                    </ul>
                </div>
                <a href="javascript:void(0)">
                    ...
                    <?php }else{?>
                    <img class="dial-rulebtn" src="<?php echo $this->_theme_url; ?>assets/subassembly/bigwheel/newassets/images/dial-rulebtn.png"/>
                    <?php }?>
                    <!--end   活动规则按钮-->
                </a>
            </div>
  ...
  <script src="<?php echo $this->_theme_url; ?>assets/subassembly/bigwheel/newassets/js/layout.js?v20156861269" type="text/javascript" charset="utf-8"></script>
        <script src="<?php echo $this->_theme_url; ?>assets/subassembly/bigwheel/newassets/js/jquery-1.12.0.min.js" type="text/javascript" charset="utf-8"></script>
        <script src="<?php echo $this->_theme_url; ?>assets/subassembly/bigwheel/newassets/js/awardRotate.js" type="text/javascript" charset="utf-8"></script>
...
<script>
    wx.config({
        ...
        timestamp: <?php echo $signPackage["timestamp"];?>,d
