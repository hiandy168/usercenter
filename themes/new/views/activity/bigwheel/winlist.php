...
<body>
    <form action="<?php echo $this->createUrl('/activity/bigwheel/WinList/fid/'.$id)?>" method="post">
    ...
    <table class="table table-striped">
        ...
        <tr>
            <td><?php echo $val['bigwheel_id']?></td>
    ...
    function set_lingjiang(parame){
    	layer.confirm('确定用户已经领奖了吗？', {
  		  ...
  		  var url = '<?php echo $this->createUrl('/activity/bigwheel/lingjiang')?>'
  		  var data = {id:parame}
