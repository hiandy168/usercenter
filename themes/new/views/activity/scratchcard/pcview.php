    ...
    <div class="ad-view-main1">
        ...
        <div class="ad-left-views">
            ...
            <div class="ad-view-app-maindiv ad-left-views1" id="reloadif">
                <iframe  src="<?php echo $this->createUrl('/activity/scratchcard/view',array('id'=>$id))?>"></iframe>
            </div>
        </div>

        <div class="ad-right-views">
    		<span> <?php if($id){ ?>
                     <img src="<?php echo  $this->createAbsoluteUrl('/qrcode/index',array('url'=>  base64_encode($this->_siteUrl.'/activity/scratchcard/view/id/'.$id)));?>" />
                        <?php }else{?>
            ...
            <div class="ad-right-views-links">
                <textarea id="fe_text" readonly="readonly"><?php echo $this->createAbsoluteUrl('/activity/scratchcard/view',array('id'=>$id))?></textarea>
