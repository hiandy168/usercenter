    ...
    <div class="ad-view-main1">
        ...
        <div class="ad-left-views">
            ...
            <div class="ad-view-app-maindiv ad-left-views1" id="reloadif">
                <iframe  src="<?php echo "http://".$_SERVER['HTTP_HOST'].$this->createUrl('/activity/scratchcard/view',array('id'=>$id))?>"></iframe>
            </div>
        </div>

        <div class="ad-right-views">
    		<span> <?php if($id){ ?>
                    <img src="http://qr.topscan.com/api.php?text=<?php echo $this->_siteUrl.'/activity/scratchcard/view/id/'.$id?>" />
                <?php }else{?>
                    <img src="http://qr.topscan.com/api.php?text=http://m.dachuw.net/h5"/>
                <?php }?></span>
            <p>为了您的体验更好<br />建议您扫码在手机上体验</p>
            <div class="ad-right-views-links">
                <textarea id="fe_text" readonly="readonly"><?php echo "http://".$_SERVER['HTTP_HOST'].$this->createUrl('/activity/scratchcard/view',array('id'=>$id))?></textarea>
