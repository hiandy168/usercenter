...
<script type="text/javascript">
	...
	<div class="wx_share_layer" id="wx_share_layer"></div>
        ...
        <!--<script type="text/javascript" src="/assets/scratch/default/js/test.js"></script>-->
    <script type="text/javascript">
            $(function(){   
                var number = 0;
                $('#scratchCard').wScratchPad({
                    size: 12,
                    bg: 'http://iy.hb.qq.com/statics/activity/scratch/default/images/bg_4.png',
                    fg: 'http://iy.hb.qq.com/statics/activity/scratch/default/images/bg_3.png',
                    scratchMove: function (e, percent) {
                        ...
                        var time = '1460691099';
                        var startTime = '1458869944';
                        var endTime = '1459094399';
        			...
        			if(number == 1) {
            			$.ajax({
                                    url: '/Components/f/ID/117/do/scratchWinner/openId/269923/FID/75',
                                        dataType: 'json'
