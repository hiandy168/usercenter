                ...
                <div class="ad-edit-app-1form">
                    ...
                    <div class="ad-act-formmain">
                        ...
                        <div class="form-content">
                            ...
                            <!-- 上传图片1 start -->
                            <div class="t_title">刮刮乐banner图片(图片大小：640*280)<i style="color:red">不传则使用系统默认图片</i></div>
                            <div class="form-inp">
                                <form id="img_scratch" method="POST" enctype="multipart/form-data" >
                                    <img id="imgPreview_vote" width="120px" height="100px"  onclick="upload('upimg1')" src="<?php if($activity_info['banner_img']) {echo JkCms::show_img($activity_info['banner_img']); }else{ echo  $this->_theme_url."assets/subassembly/scrtch_files/new/images/gg-img1.jpg";} ?> "/>
                            ...
                            <!-- 上传图片1 start -->
                            <div class="t_title">刮刮乐背景图片(最佳尺寸：750*740)<i style="color:red">不传则使用系统默认图片</i></div>
                            <div class="form-inp">
                                <form id="from_bg_img" method="POST" enctype="multipart/form-data" >
                                    <img id="img_bg_img" width="120px" height="100px" onclick="upload('up_bg_img')" src="<?php if($activity_info['bg_img']) {echo JkCms::show_img($activity_info['bg_img']); }else{ echo $this->_theme_url."assets/subassembly/scrtch_files/new/images/gg-img2.jpg";} ?> "/>
