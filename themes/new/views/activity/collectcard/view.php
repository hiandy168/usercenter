...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/css/style.css?v201568asdas61269"/>
</head>
<body>

<div id="loaddiv" class="loading-div">
    <span>
        <img src="<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/loading.gif"/>
        <i>努力加载中...</i>
    </span>
</div>
...
<div class="dial-pop">
    ...
    <div class="dial-popmain">
        ...
        <div class="popbg">
            <img src="<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-img3.png"
                 width="100%"/>
        </div>
        ...
        <div class="confirmbtnall">
            <div class="confirmbtn">
                ...
                <?php }else{ ?>
                <img
                    src="<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-confirmbtn.png"
                    width="100%"/>
                <?php } ?>
            </div>
        </div>
...
<div class="div-main">
    <div class="">
        ...
        <?php } else { ?>
            <img src="<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-bg1.jpg"
                 width="100%"/>
        <?php } ?>
        <!-- end banner-->
    </div>
    <div class="pos-r dial-div1">
        ...
        <?php } else { ?>
            <img src="<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-bg2.jpg"
                 width="100%"/>
        <?php } ?>
        <!--转盘背景图片-->
        <div class="dial-zp">
            ...
            <?php } else { ?>
                ...
                <img class="dial-zp1" id="lotteryBg"
                     src="<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-img1_<?php echo $countprize ?>.png"/>
            <?php } ?>
            <!--end 转盘图片-->
            <!--指针图片-->
            ...
            <?php } else { ?>
                <img class="dial-zp2" id="lotteryBtn"
                     src="<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-img2.png"/>
            <?php } ?>
            <!-- end 指针图片-->
        </div>
    </div>
    <div class="pos-r dial-div2">
        ...
        <?php } else { ?>
            <img src="<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-bg3.jpg"
                 width="100%"/>
        <?php } ?>
        <!--end 底部背景图片-->
        <!--中奖纪录按钮-->
        ...
        <?php } else { ?>
            <img class="dial-logbtn"
                 src="<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-logbtn.png"/>
        <?php } ?>
        <!--end 中奖纪录按钮-->
        ...
        <a href="javascript:void(0)">
            ...
            <?php } else { ?>
                <img class="dial-rulebtn"
                     src="<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-rulebtn.png"/>
            <?php } ?>
            <!--end   活动规则按钮-->
        </a>
    </div>
...
<script src="<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/js/layout.js?v20156861269"
        type="text/javascript" charset="utf-8"></script>
<script src="<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/js/jquery-1.12.0.min.js"
        type="text/javascript" charset="utf-8"></script>
<script src="<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/js/awardRotate.js"
        type="text/javascript" charset="utf-8"></script>
            ...
            $('#lotteryBg').rotate({
                ...
                callback: function () {
                    if (prizekind == 0) {
                        ...
                        <?php }else{ ?>
                        showpop('<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-img4.png', '<?php echo $info['lose_msg']  ?>', txt, daycount, 2)
                        <?php } ?>
                    } else {
                        <?php if($images->alertyes){ ?>
                        showpop('<?php echo JkCms::show_img($images->alertyes);?>', '<?php echo $info['win_msg']  ?>', txt, daycount, 2)
                        <?php }else{ ?>
                        showpop('<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-img3.png', '<?php echo $info['win_msg']  ?>', txt, daycount, 1)
                        <?php } ?>
                    }
                    bRotate = !bRotate;
                }
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.code == -1) {
                        ...
                        <?php }else{ ?>
                                 if(data.msg && data.msg !='undefind'){
                                    showpop('<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-img4.png', '', '', '', 3,data.msg);
                                }else{
                                    showpop('<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-img4.png', '', '', '', 3)
                                }
                        <?php } ?>
                        return false;
                    }
                    ...
                    if (data.code == -2) {
                        ...
                        <?php }else{ ?>
                        showpop('<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-img4.png', '', '', '', 6)
                        <?php } ?>
                        return false;
                    }
                    ...
                    if (data.code == -3) {
                        ...
                        <?php }else{ ?>
                        showpop('<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-img4.png', '', '', '', 4)
                        <?php } ?>
                        return false;
                    }
                    ...
                    if (data.dayCount != 'undefined' && data.dayCount == 0) {
                        ...
                        <?php }else{ ?>
                        showpop('<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/newassets/images/dial-img4.png', '', '', '', 5)
                        <?php } ?>
                        return false;
                    } else {
...
var winninglist_img = "<?php echo $images->winninglist?JkCms::show_img($images->winninglist):$this->_theme_url.'assets/subassembly/collectcard/newassets/images/dial-img5.png'; ?>";
...
// 中奖纪录
        ...
        function myjiangp() {
            ...
            $.post('<?php echo $this->createUrl('/activity/collectcard/userwinprize')?>', {id:<?php echo $param['id']?>}, function (data) {
               ...
               $(".dial-poptxt").html('<p><br />'
                ...
                if (kind == 1) {
                    if (daycount == 1) {
                        ...
                        if ("<?php echo $param['backUrl'];?>" != 0) {
                            $(".confirmbtnall").html('<div><a href="<?php echo $param['backUrl'];?>"><img src="<?php if ($images->colse){ echo JkCms::show_img($images->colse); } else { echo $this->_theme_url."assets/subassembly/collectcard/newassets/images/dial-confirmbtn.png";} ?>" width="100%" /></a></div>');
                        }
                    } else {
                        $(".dial-poptxt").html('<p><span>' + zjtxt + '</span><br />'
                            + '<em>中得"' + jdname + '"</em>'
                ...
                if (kind == 2) {
                    if (daycount == 1) {
                        $(".dial-poptxt").html('<p><span>' + zjtxt + '</span><br />'
                            ...
                            + '<i>您的机会已经用完了</i>');
                        if ("<?php echo $param['backUrl'];?>" != 0) {
                            $(".confirmbtnall").html('<div class="confirmbtn"><a href="<?php echo $param['backUrl'];?>"><img src="<?php if ($images->colse){ echo JkCms::show_img($images->colse); } else { echo $this->_theme_url."assets/subassembly/collectcard/newassets/images/dial-confirmbtn.png";} ?>" width="100%" /></a></div>');
                        }
                    } else {
                        $(".dial-poptxt").html('<p><span>' + zjtxt + '</span><br />'
                            + '<em>' + jdname + '</em>'
                ...
                if (kind == 5) {
                    $(".dial-poptxt").html('<p><br />'
                        ...
                        + '</p>');
                    if ("<?php echo $param['backUrl'];?>" != 0) {
                        $(".confirmbtnall").html('<div class=""><a href="<?php echo $param['backUrl'];?>"><img src="<?php if ($images->colse){ echo JkCms::show_img($images->colse); } else { echo $this->_theme_url."assets/subassembly/collectcard/newassets/images/dial-confirmbtn.png";} ?>" width="100%" /></a></div>');
                    }
                }
                if (kind == 6) {
                    $(".dial-poptxt").html('<p><br />'
...
<script type="text/javascript" src="<?php echo $this->_theme_url; ?>assets/subassembly/collectcard/assets/globe.js">
