...
<div class="op-login-div" style="padding: 20px 40px; ">
    ...
    <form id="op-login-div" action="<?php echo $this->createUrl('/sso/service/login'); ?>" method="post">
        ...
        <a href="<?php echo $this->createUrl('member/qqlogin/')?>?state=<?php echo urlencode($this->createUrl('/sso/service/callsetticket/'))?>" class="three" ><img src="<?php echo $this->_theme_url; ?>assets/images/QQ.png"></a>
        <a style='float:right' href="<?php echo $this->createUrl('member/wxgetcode/')?>?state=<?php echo urlencode($this->createUrl('/sso/service/callsetticket/'))?>" ><img src="<?php echo $this->_theme_url; ?>assets/images/weixin.png"></a>
