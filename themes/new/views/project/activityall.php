...
//             }
        ...
        <div class="ad-app-list-tit clearfix"
             style='margin-top:10px;margin-right:0;border-top: 1px solid #E6E6E6;padding: 0;overflow: inherit;'>
        ...
        <div class="ad-act-all-list clearfix bxbg"
             style='margin:0 auto;text-align:center; box-shadow: none;    margin-bottom: 30px;'>
            <ul class='clearfix w1000 ' style="margin:0 auto;text-align:left">
                <?php if ($temp) {
                    foreach ($temp as $val) { ?>
                        <li style='margin-bottom: 20px;float:none;display:inline-block;border:0' <?php if (!status($val['activity_name'], $pid) || $val['activity_name'] == '众筹' || $val['activity_name'] == '零元购') {
                            echo 'class="unable" onclick="layer.msg(\'活动未启用\')" ';
                        } ?>>
                                                            ...
                                                            <a href="<?php echo $this->createUrl('/activity/duobao/list', array('pid' => $pid, 'active' => 8)); ?>">
                                                                ...
                                                                <a href="#">
                                                                    ...
                                                                    <a href="<?php echo $this->createUrl('/activity/wenda/list', array('pid' => $pid, 'active' => 10)); ?>">
                                                                        <?php } else if ($val['activity_name'] == '集卡') { ?>
                                                                        <a href="<?php echo $this->createUrl('/activity/collectcard/list', array('pid' => $pid, 'active' => 11)); ?>">
                                                                            <?php }
                                                                            }else{ ?>
                                                                            <a href="#">
                                                                                <?php } ?>
                                                                                <?php if ($val['activity_name'] == '众筹' || $val['activity_name'] == '零元购') { ?>
                                                                                    <span><img
                                                                                            ...
                                                                                            src="<?php echo $this->_theme_url . $val['activity_nouse_img']; ?>"></span>
                                                                                <?php } else { ?>
                                                                                    <span><img
                                                                                            style='width:50px;height:50px;'
                                                                                            src="<?php if (status($val['activity_name'], $pid)) {
                                                                                                echo $this->_theme_url . $val['activity_img'];
                                                                                            } else {
                                                                                                echo $this->_theme_url . $val['activity_nouse_img'];
                                                                                            } ?>"></span>
                                                                                <?php } ?>
